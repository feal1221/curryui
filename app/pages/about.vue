  ...
  >
    ...
    >
      <UiField :data-invalid="errors.name">
        <UiFieldLabel
          for="name"
          class="text-sm sm:text-base text-[var(--primary-brown)] font-bold"
          >您的暱稱是</UiFieldLabel
        >
        <UiInput
          v-model="name"
          ...
          id="name"
          placeholder="請輸入暱稱"
          class="text-sm sm:text-base border-t-0 border-l-0 border-r-0 border-b border-gray-300 rounded-none px-0 focus-visible:ring-0 focus-visible:border-[var(--primary-brown)] tracking-widest"
        />
      ...
      <UiField :data-invalid="errors.gender">
        <UiFieldLabel
          ...
          >您的性別</UiFieldLabel
        >
        <UiRadioGroup v-model="gender" id="gender" class="text-sm sm:text-base font-bold text-[var(--primary-brown)]">
      ...
      <UiField :data-invalid="errors.age">
        <UiFieldLabel
          ...
          >您的年齡</UiFieldLabel
        >
        <UiRadioGroup v-model="age" id="age" class="text-sm sm:text-base font-bold text-[var(--primary-brown)]">
          <div class="flex items-center space-x-2">
      ...
      <UiButton
        variant="destructive"
        type="submit"
        class="self-center w-full sm:w-40 sm:self-end text-sm sm:text-base py-2 sm:py-3 px-12"
      >
        START
      </UiButton>
    </form>
